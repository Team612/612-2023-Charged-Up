...
import frc.robot.commands.TurnLedsPurple;
import frc.robot.commands.TurnLedsYellow;
...
public class ShuffleBoardButtons {
    ...
    public LEDS s_led = new LEDS();
    public TurnLedsPurple m_ledpurple = new  TurnLedsPurple(s_led);
    ...
    public void initButtons(){
        ...
        //m_ledpurple = m_smartdashboard.add("Purple LED", 0).getEntry();
        //LED_YELLOW = m_smartdashboard.add("Yellow LED", 0).getEntry();
