...
public class BackwardAutoBalance extends CommandBase {
  /** Creates a new BackwardAutoBalance. */
  private final Drivetrain m_drivetrain;
  private double speed = 0.3;
  public int offbalancepositivehalf = 7;
  public BackwardAutoBalance(Drivetrain drivetrain) {
